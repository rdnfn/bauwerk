...
Note that this PEARL implementation hides the setup of the MetaEvluator,
unlike the MAML implementation.
"""

# Adaptated imports for Bauwerk
...
@click.option("--episode_len", default=24 * 7)  # custom Bauwerk
@wrap_experiment
