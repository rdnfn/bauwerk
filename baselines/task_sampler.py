""" Adapted task sampler from rlworkgroup/garage for use with Bauwerk.

Original:
https://github.com/rlworkgroup/garage/blob/2d594803636e341660cab0e81343abbe9a325353/src/garage/experiment/task_sampler.py"""
...
class MetaWorldTaskSampler(TaskSampler):
    ...
    def __init__(self, benchmark, kind, wrapper=None, add_env_onehot=False):
        ...
        self._task_orders = {
            # adapted from 50 to MW_TASKS_PER_ENV for Bauwerk
            env_name: np.arange(MW_TASKS_PER_ENV)
    ...
    def sample(self, n_tasks, with_replacement=False):
        ...
        def wrap(env, task):
            ...
            """
            # adapted Bauwerk env to have max_path_length set to self.cfg.episode_len
